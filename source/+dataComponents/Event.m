    ...
    methods
        ...
        * 
        ...
        function thisEvent = Event()
            ...
            % Registered lists
            thisEvent.time = zeros(thisEvent.BLOCKSIZE,1);
            thisEvent.type = cell(thisEvent.BLOCKSIZE,1);
            thisEvent.idObservation = cell(thisEvent.BLOCKSIZE,1);
            thisEvent.idPayoff = cell(thisEvent.BLOCKSIZE,1);
        end
