    ...
    methods
        ...
        * 
        ...
        %}
            ...
            data.addEntry('ua', 'Principal''s utility', utilityAgent);
            data.addEntry('up', 'Principal''s utility', utilityPrincipal);
            data.addEntry('contractDuration', 'Contract duration', contractDuration);
            data.addEntry('threshold', 'Contract duration', self.contract.perfThreshold);
            ...
            data.addEntry('inspectionMarker', 'Time and perf when inspections occurred', self.principal.eventList.getMarkersInfo(Event.INSPECTION, self.principal.observationList));
            data.addEntry('detectionMarker', 'Time and perf when detections occurred', self.principal.eventList.getMarkersInfo(Event.DETECTION, self.principal.observationList));
